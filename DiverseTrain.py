...
# Checkpointlerin kaydedileceği YENİ ana klasör
drive_output_dir = "/content/drive/MyDrive/NLPlora/Diverse"
...
def formatting_prompts_func(examples):
    ...
    # --- DEĞİŞİKLİK BURADA ---
    # Artık otomatik seçim yok. Sadece 'solution' kolonunu çekiyor.
...
print(f"Dataset Ayrildi -> Train Sayisi: {len(train_dataset)}, Test Sayisi: {len(eval_dataset)}")
...
# 7. Final Modeli Kaydetme
final_model_path = os.path.join(drive_output_dir, "final_lora_model_diverse")
